...
DISCHARGE_HASH_ID_150 = '396f223fbcac81058e247cacebbf3185a660c21a5097bf9258f7db2ccbc70889'
DISCHARGE_HASH_ID_250 = 'e5609aeda93f0e09af7fe87f49e2e8cb5dc64a0d578f2c526facbe9be59a57c9'
...
def create_inflow(dir_path, ts_start_date, ts_end_date, model='250m'):
    try:
        ...
        if '250m' == model:
            ...
            prepare_inflow_150(inflow_file_path, start_time, end_time, discharge_id)
