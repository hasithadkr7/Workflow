...
#cd /mnt/disks/wrf-mod/STATIONS_$rundate1
#cd /mnt/disks/wrf-mod/NCLoutput_SE
#year1=`date '+%Y'`
#month1=`date '+%m'`
#date1=`date '+%d'`
...
#file1=$h$rundate1$t
#echo $file1
#ln -fs /mnt/disks/wrf-mod/OUTPUT_SE_18/$file1 .
#ln -fs /mnt/disks/wrf-mod/NCLoutput_SE/d03_SE.nc ./d03_SE.nc
ncap   -s   "PRCP=RAINC+RAINNC+SNOWNC+GRAUPELNC" d03__SE.nc  precip.nc
ncks   -v Times   -A   d03__SE.nc   precip.nc
...
paste timedata2.txt Glencourse2.txt > Glencourse_SE.$rundate1.txt
rm Glencourse.nc
...
paste timedata2.txt Ruwanwella2.txt > Ruwanwella_SE.$rundate1.txt
rm Ruwanwella.nc
...
paste timedata2.txt Holombuwa2.txt > Holombuwa_SE.$rundate1.txt
rm Holombuwa.nc
...
paste timedata2.txt Kitulgala2.txt > Kitulgala_SE.$rundate1.txt
rm Kitulgala.nc
...
paste timedata2.txt Daraniyagala2.txt > Daraniyagala_SE.$rundate1.txt
rm Daraniyagala.nc
...
paste timedata2.txt Norton_reservoir2.txt > Norton_reservoir_SE.$rundate1.txt
...
paste timedata2.txt Kotmale_reservoir2.txt > Kotmale_reservoir_SE.$rundate1.txt
...
paste timedata2.txt Norwood2.txt > Norwood_SE.$rundate1.txt
rm Norwood.nc
...
paste timedata2.txt Jaffna2.txt > Jaffna_SE.$rundate1.txt
rm Jaffna.nc
...
paste timedata2.txt Mahapallegama2.txt > Mahapallegama_SE.$rundate1.txt
rm Mahapallegama.nc
...
paste timedata2.txt Hingurana2.txt > Hingurana_SE.$rundate1.txt
rm Hingurana.nc 
...
paste timedata2.txt Kottawa2.txt > Kottawa_SE.$rundate1.txt
rm Kottawa.nc 
...
paste timedata2.txt Orugodawatta2.txt > Orugodawatta_SE.$rundate1.txt
rm Orugodawatta.nc
...
paste timedata2.txt Uduwawala2.txt > Uduwawala_SE.$rundate1.txt
rm Uduwawala.nc
...
paste timedata2.txt Ibattara22.txt > Ibattara2_SE.$rundate1.txt
rm Ibattara2.nc
...
paste timedata2.txt Waga2.txt > Waga_SE.$rundate1.txt
rm Waga.nc
...
paste timedata2.txt Ambewela2.txt > Ambewela_SE.$rundate1.txt
rm Ambewela.nc
...
paste timedata2.txt Mulleriyawa2.txt > Mulleriyawa_SE.$rundate1.txt
rm Mulleriyawa.nc
...
paste timedata2.txt Dickoya2.txt > Dickoya_SE.$rundate1.txt
rm Dickoya.nc
...
paste timedata2.txt Malabe2.txt > Malabe_SE.$rundate1.txt
rm Malabe.nc
...
paste timedata2.txt Mutwal2.txt > Mutwal_SE.$rundate1.txt
rm Mutwal.nc
...
paste timedata2.txt Urumewella2.txt > Urumewella_SE.$rundate1.txt
rm Urumewella.nc
