...
#!/bin/bash
# wt.sh
# Download gfs data at 00, 24, 48 and 72h GFS forcast
...
#wget "http://nomads.ncep.noaa.gov/pub/data/nccf/com/gfs/prod/gfs."$(date -u '+%Y%m%d00')"/gfs.t00z.pgrb2.0p50.f024"
...
#cp gfs.t00z.pgrb2.0p50.f024 gfs.t00z.pgrb2.0p50.f024.grb2
...
#wget "http://nomads.ncep.noaa.gov/pub/data/nccf/com/gfs/prod/gfs."$(date -u '+%Y%m%d00')"/gfs.t00z.pgrb2.0p50.f048"
#mv gfs.t00z.pgrb2.0p50.f048 gfs.t00z.pgrb2.0p50.f048.grb2
#/mnt/disks/wrf-mod/WT/grib2/wgrib2/./wgrib2 gfs.t00z.pgrb2.0p50.f048.grb2 -netcdf gfs.t00z.pgrb2.0p50.f048.nc

#wget "http://nomads.ncep.noaa.gov/pub/data/nccf/com/gfs/prod/gfs."$(date -u '+%Y%m%d00')"/gfs.t00z.pgrb2.0p50.f072"
#mv gfs.t00z.pgrb2.0p50.f072 gfs.t00z.pgrb2.0p50.f072.grb2
#/mnt/disks/wrf-mod/WT/grib2/wgrib2/./wgrib2 gfs.t00z.pgrb2.0p50.f072.grb2 -netcdf gfs.t00z.pgrb2.0p50.f072.nc

#wget "http://nomads.ncep.noaa.gov/pub/data/nccf/com/gfs/prod/gfs."$(date -u '+%Y%m%d00')"/gfs.t00z.pgrb2.0p50.f096"
#mv gfs.t00z.pgrb2.0p50.f096 gfs.t00z.pgrb2.0p50.f096.grb2
#/mnt/disks/wrf-mod/WT/grib2/wgrib2/./wgrib2 gfs.t00z.pgrb2.0p50.f096.grb2 -netcdf gfs.t00z.pgrb2.0p50.f096.nc
cp ../Scripts/WT_* .
python WT_00.py
python WT_24.py
python WT_48.py
