...
#cd /mnt/disks/wrf-mod/NCLoutput_E/
#year1=`date '+%Y'`
#month1=`date '+%m'`
#Gdate1=`date '+%d'`
...
#file1=$h$rundate1$t
#echo $file1
#ln -fs /mnt/disks/wrf-mod/OUTPUT_E.18/$file1 .
#ln -fs /mnt/disks/wrf-mod/NCLoutput_E/d03_E.nc ./d03_E.nc
ncap   -s   "PRCP=RAINC+RAINNC+SNOWNC+GRAUPELNC" d03__E.nc  precip.nc
ncks   -v Times   -A    d03__E.nc   precip.nc
...
paste timedata2.txt Glencourse2.txt > Glencourse_E.$rundate1.txt
rm Glencourse.nc
...
paste timedata2.txt Ruwanwella2.txt > Ruwanwella_E.$rundate1.txt
rm Ruwanwella.nc
...
paste timedata2.txt Holombuwa2.txt > Holombuwa_E.$rundate1.txt
rm Holombuwa.nc
...
paste timedata2.txt Kitulgala2.txt > Kitulgala_E.$rundate1.txt
rm Kitulgala.nc
...
paste timedata2.txt Daraniyagala2.txt > Daraniyagala_E.$rundate1.txt
rm Daraniyagala.nc
...
paste timedata2.txt Norton_reservoir2.txt > Norton_reservoir_E.$rundate1.txt
...
paste timedata2.txt Kotmale_reservoir2.txt > Kotmale_reservoir_E.$rundate1.txt
...
paste timedata2.txt Norwood2.txt > Norwood_E.$rundate1.txt
rm Norwood.nc
...
paste timedata2.txt Jaffna2.txt > Jaffna_E.$rundate1.txt
rm Jaffna.nc
...
paste timedata2.txt Mahapallegama2.txt > Mahapallegama_E.$rundate1.txt
rm Mahapallegama.nc
...
paste timedata2.txt Hingurana2.txt > Hingurana_E.$rundate1.txt
rm Hingurana.nc 
...
paste timedata2.txt Kottawa2.txt > Kottawa_E.$rundate1.txt
rm Kottawa.nc 
...
paste timedata2.txt Orugodawatta2.txt > Orugodawatta_E.$rundate1.txt
rm Orugodawatta.nc
...
paste timedata2.txt Uduwawala2.txt > Uduwawala_E.$rundate1.txt
rm Uduwawala.nc
...
paste timedata2.txt Ibattara22.txt > Ibattara2_E.$rundate1.txt
rm Ibattara2.nc
...
paste timedata2.txt Waga2.txt > Waga_E.$rundate1.txt
rm Waga.nc
...
paste timedata2.txt Ambewela2.txt > Ambewela_E.$rundate1.txt
rm Ambewela.nc
...
paste timedata2.txt Mulleriyawa2.txt > Mulleriyawa_E.$rundate1.txt
rm Mulleriyawa.nc
...
paste timedata2.txt Dickoya2.txt > Dickoya_E.$rundate1.txt
rm Dickoya.nc
...
paste timedata2.txt Malabe2.txt > Malabe_E.$rundate1.txt
rm Malabe.nc
...
paste timedata2.txt Mutwal2.txt > Mutwal_E.$rundate1.txt
rm Mutwal.nc
...
paste timedata2.txt Urumewella2.txt > Urumewella_E.$rundate1.txt
rm Urumewella.nc
