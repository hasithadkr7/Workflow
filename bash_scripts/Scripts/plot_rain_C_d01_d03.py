...
subprocess.run("cp -f /mnt/disks/wrf-mod/run_* .",shell=True)
...
ds.RAINNC[:,38:44,34:41].to_netcdf(path="d01_Kelani_RAINNC_"+str(date)+"_C.nc",engine="scipy")
ds.RAINC[:,38:44,34:41].to_netcdf(path="d01_Kelani_RAINC_"+str(date)+"_C.nc",engine="scipy")
ds.U10[:,38:44,34:41].to_netcdf(path="d01_Kelani_U10_"+str(date)+"_C.nc",engine="scipy")
ds.V10[:,38:44,34:41].to_netcdf(path="d01_Kelani_V10_"+str(date)+"_C.nc",engine="scipy")
ds.U[:,0,38:44,34:41].to_netcdf(path="d03_Kelani_U1_"+str(date)+"_C.nc",engine="scipy")
ds.V[:,0,38:44,34:41].to_netcdf(path="d03_Kelani_V1_"+str(date)+"_C.nc",engine="scipy")
#[6.2375183 6.4810715 6.7245026 6.967819  7.211014  7.454071 ]
#[79.54869  79.79375  80.03881  80.283875 80.52894  80.774    81.019066]
nc_f = "./d03__C.nc"
#Save RAINNC and RAINC
ds = xr.open_dataset(nc_f, engine="netcdf4")
ds.RAINNC.to_netcdf(path="d03_RAINNC_"+str(date)+"_C.nc",engine="scipy")
ds.U10.to_netcdf(path="d03_U10_"+str(date)+"_C.nc",engine="scipy")
ds.V10.to_netcdf(path="d03_V10_"+str(date)+"_C.nc",engine="scipy")
ds.U[:,0,:,:].to_netcdf(path="d03_U1_"+str(date)+"_C.nc",engine="scipy")
ds.V[:,0,:,:].to_netcdf(path="d03_V1_"+str(date)+"_C.nc",engine="scipy")
