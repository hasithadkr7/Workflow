...
from LibForecastTimeseries import extractForecastTimeseries
from LibForecastTimeseries import extractForecastTimeseriesInDays
from Utils import getUTCOffset
...
def save_forecast_timeseries(my_adapter, my_timeseries, my_model_date, my_model_time, my_opts):
    ...
    # for ll in extracted_timeseries :
    #     print(ll)
    ...
    print('is_station_exists : ', is_station_exists)
...
try:
    ...
    flo2d_source = adapter.get_source(name='FLO2D_150')
    try:
